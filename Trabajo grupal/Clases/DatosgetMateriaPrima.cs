...
namespace Trabajo_grupal.Clases
{
    public class Datosget
    {
        ...
        public Datosget(Int64 pCodigo, string pNombre_Mercancia, string pDescripcion, string pTipo_Producto, string Docenas, string Unidad, 
            string Lotes,Int64 pCantidad,  Int64 pInv_Minimo, string pColor_Producto, string Precio_Compra)
        {
            this.Codigo = pCodigo;
