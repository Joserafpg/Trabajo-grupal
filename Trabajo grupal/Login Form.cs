    ...
    public partial class Login_Form : Form
    {
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Permisos.FormCobrar = Convert.ToBoolean(dt.Rows[0][9]);
                ...
                Permisos.FormPagar = Convert.ToBoolean(dt.Rows[0][14]);
                ...
                Permisos.FormFactura = Convert.ToBoolean(dt.Rows[0][19]);
                ...
                Permisos.FormClientes = Convert.ToBoolean(dt.Rows[0][24]);
